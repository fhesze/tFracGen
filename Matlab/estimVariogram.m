...
%selectedStat = [61, 46, 28, 93, 26, 13, 90, 4, 40, 79, 39, 77, 66, 87, 27, 8, 25, 4, 84, 44, 46, 62, 3, 61, 70, 11, 54, 28, 59, 12, 69, 29, 47, 54, 29, 39, 33, 80, 28, 78, 34, 64, 5, 61, 25, 29, 14, 51, 4, 35, 51, 78, 77, 85, 33, 64, 67, 57, 67, 46, 21, 81, 43, 47, 37, 32, 4, 58, 34, 28, 93, 74, 2, 18, 58, 5, 3, 67, 96, 80, 30, 7, 55, 26, 88, 10, 16, 7, 74, 14, 77, 57, 92, 87, 37, 94, 1, 94, 87, 14];
...
for n = 1:xLen
    ...
    switch flag
        case 'X'
            ...
            %[Gamma(2, :) meanLag] = VariogramEstim(ySel, ones(size(ySel)), uSel);
        case 'Y'          
